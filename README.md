...
## 👨‍💻 About Me
I am a passionate Researcher & AI Architector with over 25+ years of research experience and 1.4k+ citations [Google Scholar ↗](https://scholar.google.com/citations?hl=en&user=egvnjnQAAAAJ)
...
| **[DS Tools](https://github.com/s-kav/ds_tools)** | Python, Pandas, NumPy, Sklearn, Plotly | 30+ reusable modules for EDA, feature engineering, model evaluation, distances estimation | [GitHub](https://github.com/s-kav/ds_tools) |
...
| **SCOPE Optimizer** | Python, PyTorch, CVXPY, SCS, NumPy, pytest, Ruff, uv | Built a certificate-guided optimizer prototype using stochastic Performance Estimation Problems, with dimension-free expected-decrease certificates and corrected certificate semantics validated by more 300 passing tests | will be soon opened |
| **Multimodal Satellite Imagery Oriented Object Detection** | Python, PyTorch, NumPy, pytest, Ruff, uv, Polars | A production-grade new-architecture model for oriented bounding box (OBB) detection and instance segmentation from multimodal satellite imagery. Supports up to N simultaneous input modalities (SAR, PAN, IR, Time Series, RGB, Text, and custom), with graceful handling of missing modalities at both training and inference time | will be soon opened |
| **PreFA: Pre-computed Function Activations** | Python, CuPy, NumPy, pytest, Ruff, uv, Numba JIT | High-performance lookup table (LUT) implementation for neural network activation (Sigmoid, Swish/SiLU, GELU, Mish, Softplus, Tanh, Sin, Cos, Tan, Sinh, Cosh, Erf, PReLU, Gamma, BesselJ0, [S4](https://github.com/s-kav/s3_s4_activation_functio)) functions with focus on speed optimization and cache efficiency | will be soon opened |
